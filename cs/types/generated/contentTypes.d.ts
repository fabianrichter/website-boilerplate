...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    teaserImage: Attribute.Component<'internal.image'> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiConfigFooterConfigFooter extends Schema.SingleType {
  collectionName: 'config_footers';
  info: {
    singularName: 'config-footer';
    pluralName: 'config-footers';
    displayName: 'Config: Footer';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::config-footer.config-footer',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiConfigHeaderConfigHeader extends Schema.SingleType {
  collectionName: 'config_headers';
  info: {
    singularName: 'config-header';
    pluralName: 'config-headers';
    displayName: 'Config: Header';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiContactSubmissionContactSubmission
  ...
  attributes: {
    msgBody: Attribute.Text & Attribute.Required;
